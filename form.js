...
var nomReg       = RegExp (/^[A-Za-z][A-Za-z\é\è\ê\-]+$/);
var prenomReg    = RegExp (/^[A-Za-z][A-Za-z\é\è\ê\-]+$/);
var emailReg     = RegExp(/^[_a-z0-9-]+(.[_a-z0-9-]+)@[a-z0-9-]+(.[a-z0-9-]+)(.[a-z]{2,3})$/);                                           //le + indique que le caractère doit être present une fois
//var birthDateReg = RegExp (/^([0-2][0-9]|(3)[0-1])(\/)(((0)[0-9])|((1)[0-2]))(\/)\d{4}$/); //le $ indique ou doit finir la chaine de caractère à contrôler
